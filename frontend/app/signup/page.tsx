  ...
  return (
    <div className="mx-auto max-w-md px-6 py-16">
      <div className="rounded-3xl border border-violet-500/20 bg-slate-900/80 p-8">
        ...
        <p className="mt-2 text-slate-300">Join BazaArts and start selling creative work.</p>
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          <input value={displayName} onChange={(event) => setDisplayName(event.target.value)} placeholder="Display name" className="w-full rounded-xl border border-violet-400/30 bg-slate-950 px-4 py-3 text-white" required />
